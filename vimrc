...
func SetTitle()
    ...
    if &filetype == 'sh'
        ...
        call append(line(".")+4, "#         Mail: banish@taomee.com")
    ...
    elseif &filetype == 'python'
        ...
        call append(line(".")+5, "#         Mail: banish@taomee.com")
    ...
    elseif &filetype == 'lua'
        ...
        call append(line(".")+3, "--         Mail: banish@taomee.com")
...
let g:DoxygenToolkit_authorName="banish"
...
let g:syntastic_cpp_include_dirs = ['/usr/include/', '/usr/local/include/', '/usr/include/c++/4.6', '/usr/include/linux', '/usr/include/libxml2/', '/usr/include/x86_64-linux-gnu', '/usr/include/c++/4.6/x86_64-linux-gnu/', '/usr/include/glib-2.0/', '/usr/include/glib-2.0/gio/', '/usr/include/glib-2.0/glib/', '/usr/include/glib-2.0/gobject/', '/usr/local/include/google/', '/usr/local/include/google/protobuf/', '/usr/local/include/async_serv/', '/usr/local/include/serverbench/', '/usr/include/libtaomee/', '/usr/include/libtaomee++/', '/usr/share/st3rd_pkg/', '/opt/banish/workspace/svn/aturtle/server/base/', '/opt/banish/workspace/svn/aturtle/server/proto/trunk/src/', '/opt/banish/workspace/svn/aturtle/server/tools/framework/libtaomee', '/opt/banish/workspace/svn/aturtle/server/tools/framework/libtaomee++', '/opt/banish/workspace/svn/aturtle/server/tools/framework/asynserv', '/opt/banish/workspace/svn/aturtle/server/tools/framework/serverbench_v2', ]
...
"set tags+=./tags,/opt/banish/workspace/git/github/node,/usr/include/c++/4.6/cpp.tags,/usr/include/linux/tags,/usr/include/x86_64-linux-gnu/tags,/opt/banish/workspace/svn/aturtle/server/online/trunk/src/tags,/opt/banish/workspace/svn/aturtle/server/db/trunk/src/tags,/opt/banish/workspace/svn/aturtle/server/gateway/trunk/src/tags,/opt/banish/workspace/svn/aturtle/server/switch/trunk/src/tags,/opt/banish/workspace/svn/aturtle/server/login/trunk/src/tags,/opt/banish/workspace/svn/aturtle/server/base/tags,/opt/banish/workspace/svn/aturtle/server/tools/framework/tags,/opt/banish/workspace/svn/aturtle/server/proto/trunk/src/tags,/opt/banish/workspace/svn/aturtle/server/tags
